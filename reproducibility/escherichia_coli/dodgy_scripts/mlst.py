...
if __name__ == "__main__":
    ...
    output_dir = 'ecoli_mlst_results_db'
    genome_table_dir = '../qualibact/docs/Escherichia/Escherichia_coli/'
    name = "ecoli"
    # main(directory_fasta, output_dir, genome_table_dir, name)

    # S aureus
    #directory_fasta = '/well/aanensen/shared/atb/saureus/'
    output_dir = 'saureus_mlst_results_db'
    genome_table_dir = '../qualibact/docs/Staphylococcus/Staphylococcus_aureus/'
    name = "saureus"
    main(directory_fasta, output_dir, genome_table_dir, name)

    # S enterica
    #directory_fasta = '/well/aanensen/shared/atb/senterica/'
    output_dir = 'senterica_mlst_results_db'
    genome_table_dir = '../qualibact/docs/Salmonella/Salmonella_enterica/'
    name = "senterica"
    main(directory_fasta, output_dir, genome_table_dir, name)
